							...
							<div class="text-center">
								<p class="footer-copyright">
									...
									?>
										...
										<?php _e( 'Theme:', '2IT-Innov' ); ?> <a href="<?php echo esc_url( '' ); ?>" target="_blank" title="<?php _e( 'Free One Page Parallax WordPress Theme', 'pixova-lite' ); ?>"><?php _e( 'Pixova Lite', 'pixova-lite' ); ?></a>
										&middot;
										<?php _e( 'Made with','pixova-lite' ); ?> <span class="footer-heart-icon fa fa-heart"></span> <?php _e( ' by ', '2IT-Innov' ); ?> 
										<a href="#" title="Premium Professional Responsive WordPress Themes"><?php _e( 'Colorlib', 'pixova-lite' ); ?></a>
										&middot; 
